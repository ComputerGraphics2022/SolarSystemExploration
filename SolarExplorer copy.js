...
window.onload = function init() 
{
	...
	/* create astroid */
	var astroids = createAstroid(7, 32);
	astroids.position.set(200, 20, 0);
	scene.add(astroids);
	...
	function createAstroid(radius, segments){
		return new THREE.Mesh(
			new THREE.SphereGeometry(radius, segments, segments),
			new THREE.MeshPhongMaterial({
				map:		THREE.ImageUtils.loadTexture('images/asteroids/baseColor.jpeg'),
				bumpMap:	THREE.ImageUtils.loadTexture('images/asteroids/normal.png'),
				bumpScale:	0.01
			})
		);
	}
